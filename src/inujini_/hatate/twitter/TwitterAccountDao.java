package inujini_.hatate.twitter;
		...
		return new DatabaseHelper(context).get(query, context, new Func1<Cursor, Twitter>(){
			...
			public Twitter call(Cursor c) {
				return new TwitterFactory(
						...
						.setOAuthAccessToken(c.getString(c.getColumnIndex(MetaAccount.AccessToken.getColumnName())))
						.setOAuthAccessTokenSecret(c.getString(c.getColumnIndex(MetaAccount.AccessSecret.getColumnName())))
