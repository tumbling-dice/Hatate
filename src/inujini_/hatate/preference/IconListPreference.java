...
public class IconListPreference extends ListPreference {
	...
	public IconListPreference(Context context, AttributeSet attrs) {
		...
		@Cleanup("recycle") val t = context.obtainStyledAttributes(attrs, R.styleable.IconListPreference);
		_icon = t.getResourceId(R.styleable.IconListPreference_android_icon, -1);
