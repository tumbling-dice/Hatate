...
public class IconEditTextPreference extends EditTextPreference {
	 ...
	 * @param attrs
	 */
	public IconEditTextPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}
	...
	private void init(Context context, AttributeSet attrs) {
		@Cleanup("recycle") val t = context.obtainStyledAttributes(attrs, R.styleable.IconEditTextPreference);
		_icon = t.getResourceId(R.styleable.IconEditTextPreference_android_icon, -1);
